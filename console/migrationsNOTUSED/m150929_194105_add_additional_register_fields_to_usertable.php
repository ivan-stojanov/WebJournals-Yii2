...
class m150929_194105_add_additional_register_fields_to_usertable extends Migration
{
	public function up()
	{
		...
		$this->addColumn('user', 'date_of_birth', 'varchar(100) DEFAULT NULL');
		$this->addColumn('user', 'middle_name', 'varchar(100) DEFAULT NULL');
		$this->addColumn('user', 'address', 'varchar(255) DEFAULT NULL');
		...
		$this->addColumn('user', 'phone_one', 'varchar(100) DEFAULT NULL');
		$this->addColumn('user', 'phone_two', 'varchar(100) DEFAULT NULL');
		$this->addColumn('user', 'is_super_admin', 'boolean DEFAULT false');
		$this->addColumn('user', 'is_admin', 'boolean DEFAULT false');
		$this->addColumn('user', 'is_user', 'boolean DEFAULT false');
		$this->addColumn('user', 'user_image', 'varchar(255) DEFAULT NULL');
		$this->addColumn('user', 'last_login', 'int(11) DEFAULT NULL');
	...
	public function down()
	{
		...
		$this->dropColumn('user', 'phone_one');
		$this->dropColumn('user', 'phone_two');
		$this->dropColumn('user', 'is_super_admin');
		$this->dropColumn('user', 'is_admin');
		$this->dropColumn('user', 'is_user');

...
?>
<div class="moveforreject-form">
    <p>Dear <?= Html::encode($modelArticleAuthor->author->fullName) ?>,</p>

    <p>This is a notification from the site "<?= \Yii::$app->name ?>".</p>
    
    <p>Your article with the title '<?= $modelArticleAuthor->article->title ?>' has been rejected. Changes to it can no longer be made.</p>
    ...
    <p>You are set as correspondent author. Please see the article details by clicking <?= Html::a(Html::encode("here"), $articleLink) ?>.</p>

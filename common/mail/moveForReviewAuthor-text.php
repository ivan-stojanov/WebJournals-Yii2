...
Your article with the title '<?= $modelArticleAuthor->article->title ?>' has been sent for review. While the article is 'under review' status, changes to it can not be made.

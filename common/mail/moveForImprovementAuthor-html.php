...
<div class="moveforacceptpublication-form">
    ...
    <p>Your article with the title '<?= $modelArticleAuthor->article->title ?>' has been moved back for improvements. You can read the reviwes and do the changes to it.</p>

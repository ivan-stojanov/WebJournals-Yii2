...
?>
<div class="moveforreviewagainauthor-form">
    <p>Dear <?= Html::encode($modelArticleAuthor->author->fullName) ?>,</p>

    <p>This is a notification from the site "<?= \Yii::$app->name ?>".</p>
    
    <p>Your article with the title '<?= $modelArticleAuthor->article->title ?>' has been sent for review again, after it was moved back for improvements. While the article is 'under review' status, changes to it can not be made.</p>
